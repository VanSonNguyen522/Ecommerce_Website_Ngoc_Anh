...
const ProductCard: React.FC<ProductCardProps> = ({ image, name, price, oldPrice, isNew, isOnSale }) => {
  return (
    <div className="relative bg-white border-dotted border-[1.5px] border-gray-600 rounded-lg shadow-md overflow-hidden group p-30">
      ...
      <div className="p-4">
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          {oldPrice && <span className="text-sm line-through text-red-400">{oldPrice}</span>}
        </div>
      </div>
