...
// }) => {
//   return (
//     <Link href={`/products/${id}`} className="relative bg-white border-dotted border-[1.5px] border-gray-600 rounded-lg shadow-md overflow-hidden group p-4">
...
//           <button className="bg-gray-200 p-2 rounded-full hover:bg-green-200 hover:scale-110 transition-transform duration-200">
//             <svg
